...
class Server
{
    ...
    /**
     * Method. HtmlSpecialChars, StrIpSlashes, AddcSlashes;
     */
    ...
    public function generateToken($data) {
        return hash('sha256', $data . $this->timeStampNow());
    }
}